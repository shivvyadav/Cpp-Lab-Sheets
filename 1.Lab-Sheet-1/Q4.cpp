/*wap to read name,roll no ,address and phone number of each student in your class using structure .
 Store the information in file so that you can recover it later .
 While recovering the information form file ,sort the information alphabetically according to the name of the student.*/
